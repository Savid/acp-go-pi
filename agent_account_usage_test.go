...
func TestAccountUsageReadsThroughGatewayRoutes(t *testing.T) {
	...
	require.Equal(t, []wire.AccountUsageLimit{{ObservedAt: "2026-09-19T08:40:37Z", ID: "session", UsedPercent: 25, UsageAllowed: new(true), ResetsAt: "2026-09-19T11:29:59Z"}}, response.Limits)
